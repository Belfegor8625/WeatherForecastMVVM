...
import com.bartoszlewandowski.weatherforecastmvvm.data.db.WeatherLocationDao
...
class ForecastRepositoryImpl(
	...
	private suspend fun fetchCurrentWeather() {
		weatherNetworkDataSource.fetchCurrentWeather(locationProvider.getPreferredLocationString(), "m")
	}
